...
E=Change Lightform Primitive 
E=Explosion mode on/off 
H=Perform
Simultaneous Add 
J=Simultaneous Adder Variable Key 
*=Select colour controleffect 
SHIFT-*=Colourflow resync Shift 
H=Zero selected colour parameter bank
