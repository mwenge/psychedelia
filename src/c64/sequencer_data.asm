...
startOfSequencerData = $C300
    ...
    .BYTE $46          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 14
    .BYTE $00,$06      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $81          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 15
    .BYTE $AA,$41      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $02          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 16
    .BYTE $00,$04      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $62          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $6B          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $42          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 22
    .BYTE $02,$AE      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $01          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 23
    .BYTE $00,$07      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $1C          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 24
    .BYTE $80,$FF      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $05          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $00,$06      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $03          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 31
    .BYTE $BD,$00      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $BF          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 32
    .BYTE $00,$BF      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $C5          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $40          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $BD,$00      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $BD          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $00,$FF      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $F1          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 48
    .BYTE $FF,$00      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $20          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $AC          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 53
    .BYTE $C1,$FD      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $D1          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $41          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $C1          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $DD          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 65
    .BYTE $03,$EE      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $85          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 66
    .BYTE $EC,$C7      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $4C          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $8D          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $87          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 72
    .BYTE $EA,$85      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $FD          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $00,$FF      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $A7          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $FE          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $04          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $89          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $24          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $83          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $E1          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 144
    .BYTE $FF,$C3      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $37          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $AE          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $EA          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 151
    .BYTE $81,$EC      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $C7          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    

    ; Sequencer Position 152
    .BYTE $CC,$00      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $60          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $ED          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $FF,$00      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $28          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $FF,$00      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $F7          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $00,$FF      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $21          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $06,$01      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $2A          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $80          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $BD,$00      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $B9          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $EE,$C1      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $EC          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $E3          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $EF          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
    ...
    .BYTE $81,$BD      ; X/Y Co-ordinates: X/Y Position relative to cursor.   
    .BYTE $A5          ; Index to pattern in pixelXPositionLoPtrArray/pixelXPositionHiPtrArray   
